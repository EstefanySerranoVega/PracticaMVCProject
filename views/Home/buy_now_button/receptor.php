...
$baseUrl = 'http://localhost/html/MVC/Home/buy_now_button';
...
$pdt_identity_token = "HgjVouZZ1fvb0JI1os-3MlXMzQpZ7ePqFNBeaK11Fw6XZ-XO2LvlAfbWfw0";
error_log('receptor en ejecucion');
$tx = $_GET['tx'];
...
if (strcmp($lines[0], "SUCCESS") == 0) {
    ...
    echo "<h1>¡Hemos procesado tu pago paypal exitosamente!</h1> 
    Recibimos $mc_gross Bolivianos en concepto de: $quantity $item_name.<hr>
    Vuelve a comprar dando clic <a href='$baseUrl/formularioxd.php'>aquí</a>";
    return;
} else if (strcmp($lines[0], "FAIL") == 0) {
    
    error_log('70: receptor');
