...
<?php
    ...
    ?>
        ...
        <div class="section-productos_store">
            <h1>RESULTADOS CATEGORIA <?php echo $producto[$i]['categoria']?></h1>
            <div class="section-productos"> 
                    <?php
                    $productos = new StoreModel();
                    $producto = $productos->filterCategory($id);
                    if(count($producto )>0 ){
for($i=0;$i<count($producto);$i++){
               ...
               <form action="<?php echo URL_RAIZ;?>carrito/addCarrito?id=<?php echo $producto[$i]['id_ap'];?>"  id="card_producto" class="card-producto" method="post">
                ...
                <?php }  ?>
                        ...
                        echo 'No se encontraron los productos solicitados, regrese más tarde';
                    }?>
