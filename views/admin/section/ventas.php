                        ...
                        <div class="row-table">
                            ...
                            <div class="cell-table">
                                <div class="icons-table">
                                    <a href="<?php echo URL_RAIZ;?>sectionProductos/updateItem?id=<?php ?>">
                                    ...
                                    <a href="<?php echo URL_RAIZ;?>sectionProductos/deleteItem?id=<?php ?>">
                                    <div class="icon-action">
                                    ...
                                    <a href="<?php echo URL_RAIZ;?>sectionAlmacen/addItem?id=<?php  ?>">
                                        <div class="icon-action">
