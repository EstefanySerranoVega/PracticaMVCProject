...
<?php
   ...
   require_once('helpers/html/menuLateral.php');?>
        ...
        <div class="nav-search">
                ...
                <div class="btn-new">
                    <a href="<?php echo URL_RAIZ;?>sectionProductos/addLote">
                    <button>
                        <div class="icon-btn">
              ...
              array_push($res,$producto[$i]);  ?>
                        <div class="row-table">
                            ...
                            <div class="cell-table">
                                <?php echo $producto[$i]['codigo']; ?>
                            </div>
                            <div class="cell-table">
                                <?php echo $producto[$i]['nombre']; ?>
                            </div>
                            <div class="cell-table">
                                <?php echo $producto[$i]['name_cat']; ?> 
                            </div>
                            <div class="cell-table">
                                <?php echo $producto[$i]['precio']; ?> 
                            </div>
                            <div class="cell-table">
                                <?php echo $producto[$i]['cantidad']; ?>
                            </div>
                            <div class="cell-table">
                            <?php echo $producto[$i]['name_proveedor']; ?>
                              </div>
                            <div class="cell-table">
                                <div class="icons-table">
                                    <a href="<?php echo URL_RAIZ;?>sectionProductos/updateItem?id=<?php echo $producto[$i]['id_producto']; ?>">
                                    ...
                                    <a href="<?php echo URL_RAIZ;?>sectionProductos/deleteItem?id=<?php echo $producto[$i]['id_producto']; ?>">
                                    <div class="icon-action">
